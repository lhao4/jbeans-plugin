...
import com.github.lhao4.jbeans.service.StaticSearchService
...
class StaticSearchPanel(private val project: Project) : JPanel(BorderLayout()), Disposable {

    private val searchService get() = project.getService(StaticSearchService::class.java)
    ...
    init {
        searchField.textEditor.emptyText.text = "搜索类名 / 静态方法名..."
        resultList.cellRenderer = StaticMethodCellRenderer()
    ...
    private class StaticMethodCellRenderer : DefaultListCellRenderer() {
        override fun getListCellRendererComponent(
            ...
            if (value is MethodMeta) {
                label.text = "<html><b>${value.methodName}</b>&nbsp;" +
                        "<font color='gray'>${value.className} [static]</font></html>"
